...
function LoadAssets()
{
	...
	IMAGE.GROUNDSPRITE = new Sprite(IMAGE.GAMESIZE * 2, IMAGE.GAMESIZE * 2, "images/ground.png");
	IMAGE.WALLSPRITE = new Sprite(IMAGE.GAMESIZE * 2, IMAGE.GAMESIZE * 2, "images/wall.png");
